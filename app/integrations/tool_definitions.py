        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "scheduler": {"type": "string", "default": settings.sd_schedule_type},
                    "seed": {"type": "integer", "default": settings.sd_seed},
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Если нужно 2–12 вариантов с разным denoise — один вызов с denoising_strengths; "
                "не делайте отдельный вызов на каждый denoise (лимит 3 вызова за ход). "
                "denoising_strength: 0.20–0.36 мелкие правки; 0.37–0.48 косметика; "
                "0.49–0.62 средние; 0.63–0.74 сильные; "
                "0.75–0.92 почти новая картинка (по умолчанию 0.54)."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    ...
                    "denoising_strengths": {
                        ...
                        "description": (
                            ...
                            "(до 12). **Обязательно** при 2+ вариантах / сравнении denoise; "
                            "не вызывайте img2img отдельно на каждое значение."
                        ),
                    },
                    "resize_mode": {
                        "type": "integer",

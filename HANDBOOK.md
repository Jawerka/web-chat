...
> **Правило для ревью:** если изменение заметно ухудшает UX ради гипотетической атаки из интернета — отклонять или делать за явным флагом. Открытые задачи — [BACKLOG.md](BACKLOG.md).
...
├── .env.example, HANDBOOK.md, BACKLOG.md, Sys-prompt.md, README.md, docs/RUNBOOK.md
...
> **Архив.** Этапы 1–11 и чеклисты ниже — исторический план первичной разработки (всё выполнено). Актуальные доработки — [BACKLOG.md](BACKLOG.md); платформа P0–P2 — [§21](#21-стабилизация-и-платформа-v2-2026-05-23). Новый код сверять с [§0.5](#05-модель-эксплуатации-и-приоритеты-разработки), а не с чекбоксами этапов.
...
> Стабилизация P0–P2 зафиксирована в этом разделе. Актуальный план доработок и аудита — [BACKLOG.md](BACKLOG.md).

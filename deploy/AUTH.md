...
> **Контекст:** для личного LAN auth **не обязателен** (`AUTH_ENABLED=false` на dev). Включайте, если к хосту имеют доступ другие люди. Философия проекта — [HANDBOOK.md §0.5](../docs/HANDBOOK.md#05-модель-эксплуатации-и-приоритеты-разработки).
